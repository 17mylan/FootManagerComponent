...
- Make sur to copy the same material from the picture and use the same Param Names ("Color" & "Intensity". Color & Intensity are used to determine your color and normal intensity on the FootManager Component on your blueprint). You can change the texture as you need. --- Once it's done, make sure to create a Material Instance of your material and assign it to FootManager > PrintCircleDecal > CircleParameters > CircleDecalMaterial.
